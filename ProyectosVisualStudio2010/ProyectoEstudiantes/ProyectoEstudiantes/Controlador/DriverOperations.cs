...
namespace ProyEstudiantes.Controlador
{
    class DriverOperations
    {
        ...
        private ProyEstudiantes.Modelo.Profesor pf = new Modelo.Profesor();
        private ProyEstudiantes.Modelo.ProfesorRepositorio IRP = new Modelo.ProfesorRepositorio();
        //Objeto conector SQL
        ...
        public void CreateEstudent(string n, string ap, string am, string m, string pg, string e)
        {
        ...
        public ProyEstudiantes.Modelo.Estudiante ObtenerObjetoEstudiante(string sFiltro)
        {
           return conSQL.CreateQuerySelectEstudiante(sFiltro);
        }

        public ProyEstudiantes.Modelo.Profesor ObtenerObjetoProfesor(string sFiltro)
        {
