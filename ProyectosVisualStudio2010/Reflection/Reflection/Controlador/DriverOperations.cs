...
namespace Reflection.Controlador
{
    class DriverOperations
    {
        ...
        private Reflection.Modelo.Estudiante et = new Modelo.Estudiante();
        private Reflection.Modelo.EstudianteRepositorio IRE = new Modelo.EstudianteRepositorio();
        //Tratamiento de informacion de profesor
        private Reflection.Modelo.Profesor pf = new Modelo.Profesor();
        private Reflection.Modelo.ProfesorRepositorio IRP = new Modelo.ProfesorRepositorio();
        //Objeto conector SQL
        ...
        public Reflection.Modelo.Estudiante ObtenerObjetoEstudiante(string sFiltro)
        {
           return conSQL.CreateQuerySelectEstudiante(sFiltro);
        }

        public Reflection.Modelo.Profesor ObtenerObjetoProfesor(string sFiltro)
        {
